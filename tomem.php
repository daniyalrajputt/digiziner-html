    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-8">
          ...
          <img class="port-img" src="portfolio-images\tomem.webp" />
        </div>
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Client</strong>: Tomem</li>
              <li><strong>Project date</strong>: 14 March, 2021</li>
          ...
          <div class="portfolio-description">
            ...
            <p>
              It astounds me to understand what is it that makes us feel happy with technology. With over 30 years of having an interest in technology my answer is simple….it delivers a result that makes life easier, and stimulates our key sensors…..our eyes and ears…hence it tantalises us to bring consistency moments of happiness.
