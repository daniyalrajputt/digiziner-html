...
<body>
    ...
    <div class="main-slider innerSlider">
        <img class="img-fluid w-100" src="images/animation-pt.webp" alt="image">
    ...
    <section class="aboutSec aboutInnr">
        <div class="container">
            <div class="row align-items-center no-gutters">
                ...
                <div class="col-lg-6">
                    <img src="images/logo-design.webp" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mb-5">
                    <h2 class="secHeading">Animation; impactful, powerful, and successful</h2>
                </div>
                <div class="col-lg-4">
                    <div class="box">
