    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-8">
          ...
          <img class="port-img" src="portfolio-images\validus.webp" />
        </div>
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Client</strong>: Validus</li>
          ...
          <div class="portfolio-description">
            ...
            <p>
              The battle against infections in healthcare settings never stops. We are losing the fight against infection with more and more reports and studies detailing the increase in antimicrobial mutations against traditional methods such as alcohol.
