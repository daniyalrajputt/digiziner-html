    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-8">
          ...
          <img class="port-img" src="portfolio-images\vayo.webp" />
        </div>
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Client</strong>: Vayo</li>
              <li><strong>Project date</strong>: 13 May, 2021</li>
          ...
          <div class="portfolio-description">
            ...
            <p>
              Our Jewellery is carefully selected, We are a member of IGS (International Gem Society) & We are also certified through CPAA (Certified Pearl Association of America).
