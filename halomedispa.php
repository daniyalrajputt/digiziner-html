    ...
    <div class="container">
      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-8">
          ...
          <img class="port-img" src="portfolio-images\halospa.webp" />
        </div>
        ...
        <div class="col-lg-4">
          <div class="portfolio-info">
            ...
            <ul>
              ...
              <li><strong>Client</strong>: Halo Medi Spa</li>
              <li><strong>Project date</strong>: 05 February, 2021</li>
          ...
          <div class="portfolio-description">
            ...
            <p>
              HALO Medispa offers you unique beauty and aesthetic services by combining our deep expertise in the latest medical and cosmetic techniques.

              Our team have a true passion for inspiring our clients to meet their individual goals to achieve their better self.
